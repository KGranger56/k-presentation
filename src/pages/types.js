              ...
              <div className="container">
                <div className="box-3 a">
                  ...
                  <p className="box-b">
                    ...
                    climber is securely attached to a rope which then passes up, through
                    an anchor system at the top of the climb, and down to a belayer at the
                    foot of the climb. The belayer takes in slack rope throughout the
                    climb, so that if at any point the climber were to lose their hold,
                    they would not fall more than a short distance.
                  </p>
                </div>
                <img
            ...
            <div className="box-2 group-a">
              <div className="container">
                ...
                <div className="box-3">
                  <h3>Lead (Sport)</h3>
                  <p className="box-a">
                    Lead climbing is a climbing style where one climber has to take the
                    lead while the other climbers follow. The lead climber wears a harness
              ...
              <div className="container">
                <div className="box-3 a">
                  ...
                  <p className="box-b">
                    ...
                    in which the climber places all the necessary protection gear required
                    to arrest any falls as they are climbing, and then removes it when the
              ...
              <div className="container">
                ...
                <div className="box-3">
                  ...
                  <p className="box-a">
                    ...
                    generally undertaken on routes that require safety gear to be
                    completed safely. A fall while Soloing, will likely be fatal.
                  </p>
                </div>
              </div>
            </div>
